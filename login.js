    ...
    try {
        ...
        const nftDetails = {
            ...
            '2': {
                ...
                name: 'Level 2 Badge',
                description: 'This NFT represents your second accomplishment on StackUp Invaders which grants you a level 1 upgraded spaceship.'
            },
            '3': {
                image: 'https://bafkreifxbz53txersuyqok75dmdhyrnfkascznytyvum2i25bunii5dih4.ipfs.nftstorage.link/',
                name: 'Level 3 Badge',
                description: 'This NFT represents your third accomplishment on StackUp Invaders which grants you a level 2 upgraded spaceship.'
            }
        };
        ...
        nft.innerHTML = `
      <div id="nft-popup-title" class="alert alert-success">Great Score! Claim this NFT, then resume the game.</div>
      <div id="nft-popup" class="card" >
      <div class="card-body">
        <div class="media">
